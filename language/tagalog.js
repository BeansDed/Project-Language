const vocabulary = {
    tagalog: {
        words: [
            ...
            { word: "tag-araw", translation: "Dry Season", hint: "panahon ng kakaunting pag-ulan" },
            { word: "burol", translation: "Hill", hint: "mababang bundok" },
            { word: "bundok", translation: "Mountain", hint: "mas mataas kaysa burol" },
            { word: "ilog", translation: "River", hint: "tumatakbong tubig mula sa kabundukan" },
            { word: "kapatid", translation: "Sibling", hint: "kaanak na pareho ang mga magulang" },
            { word: "ina", translation: "Mother", hint: "ang babae na nagdala at nag-alaga sa isang anak" },
            { word: "ama", translation: "Father", hint: "ang lalaking nagbigay ng buhay sa isang anak" },
            { word: "anak", translation: "Child", hint: "bata na isinilang ng magulang" },
            { word: "magulang", translation: "Parent", hint: "ang mga nag-aalaga at nagpapalaki ng anak" },
            { word: "pamilya", translation: "Family", hint: "ang mga taong magkakaugat sa isa't isa" }
        ],
        shuffle: function() {
